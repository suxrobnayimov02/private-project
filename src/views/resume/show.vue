    ...
    <div class="container">
      ...
      <div class="block">
        ...
        <div class="row">
              ...
              <a href="" class="link">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="15"
                  ...
                  <path id="Fabric_Icons" data-name="Fabric Icons"
                        ...
                        transform="translate(0 29.703)" fill="#0078d4" />
                </svg>
              ...
              <a class="info">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 30 30">
                  <path id="Fabric_Icons" data-name="Fabric Icons"
                        ...
                        transform="translate(0 32)" fill="#767676" />
                </svg>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="outline-card">
              <div class="__title "><b>0</b> <span></span></div>
              <div class="__desc">
              ...
              <li><a href="#">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14"
                  ...
                  <path id="Fabric_Icons" data-name="Fabric Icons"
                        ...
                        transform="translate(0 28)" fill="#0078d4" />
                </svg>
              ...
              <li><a href="#">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                  ...
                  <path id="Fabric_Icons" data-name="Fabric Icons"
                        ...
                        transform="translate(-0.002 32)" fill="#0078d4" />
                </svg>
              ...
              <li><a href="#">
                <svg xmlns="http://www.w3.org/2000/svg" width="13" height="16"
                  ...
                  <path id="Fabric_Icons" data-name="Fabric Icons"
                        ...
                        transform="translate(-2 32)" fill="#0078d4" />
                </svg>
